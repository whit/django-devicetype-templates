...
MOBILE_PATTERNS = getattr(settings, 'RESPONSIVE_MOBILE_PATTERNS', ('iphone', 'ipod', 'android', 'mobile', 'blackberry',
                                                                   'windows ce', 'opera mini', 'opera mobile', 'palm',
                                                                   'ipad',)
)
TABLET_PATTERNS = getattr(settings, 'RESPONSIVE_TABLET_PATTERNS', ('ipad', 'android 3', 'tablet', 'nexus 7'))
...
"""
TEMPLATE_PREFIX = getattr(settings, 'RESPONSIVE_TEMPLATE_PREFIX', {
    'desktop': '',
    'mobile': 'm-',
    'tablet': 't-',
})
